...
/*   Updated: 2024/10/21 18:43:30 by samurai0lav      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void take_fork(t_philo *philo)
{
	...
	if (!philo->is_dead)
	{
		...
		printf("%llu %d %s", current_time, philo->id, PHILO_FORK);
	}
...
void eat(t_philo *philo)
{
	...
	// {
		...
		// printf(GREEN "%llu\n" RESET, philo->time_to_eat);
		printf("%llu %d %s", current_time, philo->id, PHILO_EAT);
